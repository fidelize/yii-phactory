...
class FTestLib
{
    ...
    /**
     * Remove palavras reservadas do SQL, espaços em branco, e condições esperadas
     * restando apenas texto que não foi tratado pelo teste
     * @param array $aCriteria
     * @param array $aCondicaoEsperada
     * @return string vazia caso nao haja nenhuma condicao além das esperadas.
     * senão retorna as condicoes extras
     */
